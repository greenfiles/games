...
TitleScreen = function() {
    ...
    BasicButton.apply(this.productInfoButton, function() {
        ...
        window.open(PROFILE.mobile ? "http://m.your-website-name.co.uk/food_single_item.php?item_id\x3d11589" :
            "http://greenish.xyz", "_blank")
    });
    var a = document.createElement("div");
    a.className = "legals";
    a.innerHTML = "\x3cdiv style\x3d'margin-left:10px;'\x3eCopyright © 2017 - Greenish Games in association with McDonald’s Corporation. \x3ca style\x3d'color:#fae5be' href\x3d" +
